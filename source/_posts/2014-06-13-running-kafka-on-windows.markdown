...
Then I wanted to try out [the .net client library](https://github.com/Jroland/kafka-net), so went to run the windows bat files, and sadly it didn't work. Sadness :(. However there is a way to get it working under Windows using some Cywin magic.
...
* [Babun](https://github.com/babun/babun) installed (if you already have Cywin set up you can use that, but I'll carry on assuming you're using babun because it makes it so easy!)
